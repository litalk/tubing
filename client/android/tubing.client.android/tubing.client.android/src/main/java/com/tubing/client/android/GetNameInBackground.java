...
public class GetNameInBackground extends AbstractGetNameTask {
  ...
  public GetNameInBackground(GooglePlayServicesActivity activity, String email, String scope) {
  ...
  private Intent makeCallback(String accountName) {
      ...
      intent.putExtra(GooglePlayServicesActivity.EXTRA_ACCOUNTNAME, accountName);
      intent.putExtra(GooglePlayServicesActivity.TYPE_KEY, GooglePlayServicesActivity.Type.BACKGROUND.name());
  ...
  public static class CallbackReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent callback) {
        ...
        Intent intent = new Intent(context, GooglePlayServicesActivity.class);
